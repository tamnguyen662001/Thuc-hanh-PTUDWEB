...
{
    public class NhanVien_61134311Controller : Controller
    {
        // GET: NhanVien_61134311
        ...
        [HttpPost]
        public ActionResult Index(HttpPostedFileBase Avatar, EmployerModel emp)
        {
        ...
        public ActionResult Confirm(EmployerModel emp)
        {
            return View();
        }
    }
